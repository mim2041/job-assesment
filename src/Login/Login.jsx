    ...
    <div>
      ...
      <div className="hidden md:flex md:flex-col lg:flex-row lg:items-center lg:justify-center lg:px-36  gap-20 py-5">
        ...
        <div className="relative">
          ...
          <div className="bg-[#152A16] px-8 py-6 rounded-lg text-center absolute top-[42%] right-[100px] text-[22px] font-['Poppins', sans-serif] flex items-center justify-center">
