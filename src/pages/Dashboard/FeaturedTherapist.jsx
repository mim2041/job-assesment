                ...
                >
                    {
                        data?.map((therapist, i) => (
                            ...
                            <div className="card bg-white rounded-lg mx-4 relative text-left shadow-lg">
                                <img src={therapist.image} alt={therapist.name} className="card-image w-full h-40 object-cover rounded-lg mb-4 mx-auto" />
                                <h4 className="text-lg font-semibold mb-2 ml-2">{therapist.name}</h4>
                                ...
                                <button className="bg-[#156BCA] text-white py-2 px-4 rounded-b-lg hover:bg-[#D4E9FF] hover:text-black transition-all underline w-full absolute bottom-0 right-0">
                                    See Details
                                </button>
                            </div>
                        </SwiperSlide>
